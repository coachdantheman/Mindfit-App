    ...
    <div className="max-w-xl mx-auto">
      {step === 'welcome' && (
        <div className="bg-gray-900 rounded-2xl border border-white/10 p-8">
          ...
          <label className="block text-sm font-medium text-gray-300 mb-2">What&rsquo;s your primary sport?</label>
            ...
            {SPORTS.map(s => (
              <button
                ...
                className={`px-3 py-1.5 rounded-full text-sm border transition-colors ${
                  sport === s
                    ? 'bg-cta text-gray-900 border-cta font-semibold'
      ...
      {step === 'result' && mpi !== null && (
        <div className="bg-gray-900 rounded-2xl border border-white/10 p-8 text-center">
          ...
          <div className="relative w-40 h-40 mx-auto mb-6">
            <svg viewBox="0 0 100 100" className="w-full h-full -rotate-90">
              ...
              <circle
                ...
                stroke="#C4B400" strokeWidth="8" strokeLinecap="round"
          ...
          <p className="text-gray-300 font-medium mb-2">{mpiVerdict(mpi)}</p>
          ...
          <button
            onClick={finish}
            className="w-full bg-cta hover:bg-brand-600 text-gray-900 font-semibold py-3 rounded-xl transition-colors"
          >
            Start Training →
          </button>
        </div>
