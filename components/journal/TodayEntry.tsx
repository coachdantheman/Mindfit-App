...
function RatingBadge({ label, value, color }: { label: string; value: number; color: string }) {
  return (
    <div className="text-center">
      ...
      <p className="text-xs text-fg-4 mt-1">{label}</p>
    </div>
  )
}
  ...
  return (
    <div className="space-y-6">
      <div className="bg-brand-600/10 border border-brand-600/30 rounded-2xl p-4 text-center">
        ...
        <p className="text-fg-3 text-sm mt-1">Come back tomorrow for your next entry.</p>
      </div>

      {/* Ratings summary */}
      <div className="card p-6">
        <h3 className="font-semibold text-fg-1 mb-4">Today&apos;s Ratings</h3>
      ...
      <div className="card p-6 space-y-5">
        <div>
          <h4 className="text-xs font-semibold text-fg-4 uppercase tracking-wide mb-1">Objective</h4>
          <p className="text-fg-2">{entry.objective}</p>
        </div>
        <div>
          <h4 className="text-xs font-semibold text-fg-4 uppercase tracking-wide mb-1">Action Steps</h4>
          <ol className="list-decimal list-inside space-y-1 text-fg-2 text-sm">
        ...
        <div>
          <h4 className="text-xs font-semibold text-fg-4 uppercase tracking-wide mb-1">Strengths</h4>
          <ul className="list-disc list-inside space-y-1 text-fg-2 text-sm">
        ...
        <div>
          <h4 className="text-xs font-semibold text-fg-4 uppercase tracking-wide mb-1">Weakness to Focus On</h4>
          <p className="text-fg-2">{entry.weakness}</p>
        </div>
        {entry.extra_notes && (
          <div>
            <h4 className="text-xs font-semibold text-fg-4 uppercase tracking-wide mb-1">Notes</h4>
            <p className="text-fg-2">{entry.extra_notes}</p>
          </div>
        )}
      </div>
    </div>
